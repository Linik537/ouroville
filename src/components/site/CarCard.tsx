  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            className={`inline-flex rounded-full bg-gold font-inter font-normal tracking-wide text-primary-foreground ${compact ? "px-3 py-1.5 text-sm sm:px-5 sm:py-2 sm:text-lg" : "px-5 py-2 text-lg"}`}
          >
            {brl(carro.preco)}
          </span>
          <span
