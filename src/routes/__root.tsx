...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo:ital,wght@0,400..900;1,400..900&family=Audiowide&family=Barlow+Condensed:wght@600;700;800&family=Inter:wght@400;500;600&family=Oswald:wght@500;600;700&family=Russo+One&display=swap",
      },
