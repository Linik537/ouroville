...
create table if not exists public.carros (
  ...
  descricao text,
  destaque text,
  mostrar_novidades boolean not null default false,
  ordem_novidades int,
...
alter table public.carros add column if not exists mostrar_novidades boolean not null default false;
alter table public.carros add column if not exists ordem_novidades int;
...
begin
  ...
  update public.carros set mostrar_novidades = false, ordem_novidades = null
  where mostrar_novidades or ordem_novidades is not null;
  update public.carros as carro
  set mostrar_novidades = true, ordem_novidades = selecionado.posicao::integer
  ...
  into _result from public.carros as carro where carro.mostrar_novidades;
  return _result;
end;
$$;
